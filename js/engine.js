...
var Engine = (function(global) {
    ...
    function main() {
         ...
         * 来调用这个函数
         */
		!isGameOver && win.requestAnimationFrame(main);
    }
	...
	function checkCollisions() {
		allEnemies.forEach(function(enemy) {
           if (Math.floor(enemy.x/101) === Math.floor(player.x/101) && Math.floor((enemy.y + 20)/83) === Math.floor(player.y/83)) {
				player.reset()
		   } else if (Math.floor(player.y/83) === 0){
				isGameOver = true
